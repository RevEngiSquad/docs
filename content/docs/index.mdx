...
| `/dex2java`          | Convert Dex files to Java source code.                                                            |
| `/frida_compile`     | Compile and encrypt Frida scripts to be compatible with Frida environments.                       |
...
- Channel: [@RevEngiTeam](https://t.me/RevEngiTeam)
